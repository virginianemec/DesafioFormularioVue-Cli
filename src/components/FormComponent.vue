...
<template>
  <div class="div--container">
      <p>iD* - Se creará automaticamente. <br>
      Cargue los valores del formulario. Presione el botón Nuevo, o bien la tecla Enter, para guardar el producto <br>
      Si los datos no son correctos, el sistema le avisará.</p>
    <vue-form
